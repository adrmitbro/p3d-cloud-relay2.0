...
function updateUserAircraftDetails() {
            ...
            detailsPanel.innerHTML = `
                ...
                ${flightInfo ? `<div class="detail-row">
                    <span class="detail-label">Flight:</span>
                    <span class="detail-value">${flightInfo}</span>
                </div>` : ""}
                <div class="detail-row">
                    <span class="detail-label">Aircraft:</span>
                    <span class="detail-value">${currentFlightData.userAtcModel || currentFlightData.userAtcType || 'User Aircraft'}</span>
                </div>
                ${routeInfo ? `<div class="detail-row">
